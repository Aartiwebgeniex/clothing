!(function () {
                                ...
                                (e.maxHeight = 0),
                                    ...
                                    jQuery(t, e.currentElement).each(function (t) {
                                        ...
                                        i.length &&
                                            ...
                                            (e.rating.dummy =
                                                null !== (n = e.rating.dummy) && void 0 !== n
                                                    ? n
                            ...
                            init: function () {
                                ...
                                jQuery(".equalize-box", t).each((t, i) => {
                                    (e.currentElement = i),
                                        ...
                                        1 !== e.colPerRow &&
                                            ((e.disablePerRow =
                                                jQuery(i).hasClass("row-slider") || jQuery(i).hasClass("row-grid")),
                                    ...
                                    (c.prototype._init = function () {
                                        ...
                                        (c.prototype._move = function (t) {
                                            ...
                                            var c = this.$target.offset(),
                                                ...
                                                d = Math.ceil(l * i),
                                                h = Math.ceil(u * n);
                                            if ((flatsomeVars.rtl && (d = e - d), d < 0 || h < 0 || d > e || h > o))
                                                this.hide();
                                            else {
                                                var f = -1 * h,
                                                    m = -1 * d;
                                                "transform" in document.body.style
                                                    ? this.$zoom.css({
                                                          transform: `translate(${flatsomeVars.rtl ? -m : m}px, ${f}px)`,
                                                      })
                                                    : this.$zoom.css({ top: f, left: m }),
                                                    this.opts.onMove.call(this, f, m);
                                            }
                                        }),
    ...
    (a.m = n),
        ...
        (function () {
            ...
            function i() {
                return jQuery.fn.magnificPopup ? Promise.resolve() : a.e(230).then(a.t.bind(a, 9650, 23));
            }
            o(),
                ...
                (jQuery.fn.lazyMagnificPopup = function (t) {
                    ...
                    return (
                        o.one("click", (n) => {
                            n.preventDefault(),
                                i().then(() => {
                                    e.data("magnificPopup") ||
                                        e.magnificPopup({
                                            allowHTMLInStatusIndicator: !0,
                                            allowHTMLInTemplate: !0,
                                            ...t,
                                        }),
                                        e.magnificPopup("open", o.index(n.currentTarget) || 0);
                                });
                        }),
                        e
                    );
            ...
            function r(t, e) {
                const o = t.jquery ? t.get(0) : t;
                Object.entries(e).forEach(([t, e]) => {
                    const i = t.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase();
                    !(function (t, e, o) {
                        if ("aria-expanded" === e) {
                            if (!0 !== o && "true" !== o) return;
                            const e = t.hasAttribute("aria-expanded"),
                                i = "false" === t.getAttribute("aria-expanded");
                            (e && i) ||
                                console.warn(
                        ...
                        null == e || (n.includes(i) && ("false" === e || !1 === e))
                            ? o.removeAttribute(i)
                            : i.startsWith("aria-")
                              ? o.setAttribute(i, "boolean" == typeof e ? String(e) : e)
                              : !0 !== e
                                ? !1 !== e
                                    ? o.setAttribute(i, e)
                                    : o.removeAttribute(i)
            ...
            Flatsome.behavior("quick-view", {
                        ...
                        jQuery(".quick-view", t).each(function (t, o) {
                            jQuery(o).hasClass("quick-view-added") ||
                                (jQuery(o).on("click", function (t) {
                                    ...
                                    const n = jQuery(t.currentTarget);
                                    jQuery(this).parent().parent().addClass("processing");
                                    /* CUSTOM CODE START */
                                    var selectedSize = jQuery(this).attr('data-size');
                                    /* CUSTOM CODE END */
                                    var a = { action: "flatsome_quickview", product: jQuery(this).attr("data-prod") };
                                    jQuery.post(flatsomeVars.ajaxurl, a, function (t) {
                                        i().then(() => {
                                            jQuery(".processing").removeClass("processing"),
                                                ...
                                                setTimeout(function () {
                                                    ...
                                                    t.imagesLoaded(function () {
                                                        ...
                                                        e && ((t.friction = 1), (t.selectedAttraction = 1)),
                                                            jQuery(".product-lightbox .slider").lazyFlickity(t);
                                                    }),
                                                        Flatsome.attach("tooltips", t),
                                                        Flatsome.attach("a11y", t);
                                                }, 300);
                                            let i = jQuery(".product-lightbox form.variations_form");
                                            jQuery(".product-lightbox form").hasClass("variations_form") &&
                                                i.wc_variation_form();
                                            let a = jQuery(".product-lightbox .product-gallery-slider"),
                                                s = jQuery(
                                                    ".product-lightbox .product-gallery-slider .slide.first img"
                                                ),
                                                c = jQuery(".product-lightbox .product-gallery-slider .slide.first a"),
                                                l = s.attr("data-src") ? s.attr("data-src") : s.attr("src");
                                            const u = jQuery.Deferred();
                                            a.one("flatsome-flickity-ready", () => u.resolve());
                                            let d = function () {
                                                    a.data("flickity") && a.flickity("select", 0);
                                                },
                                                h = function () {
                                                    a.data("flickity") &&
                                            ...
                                            jQuery.when(u).done(() => {
                                                i.on("hide_variation", function (t, e) {
                                                    s.attr("src", l).attr("srcset", ""), h();
                                                }),
                                                    i.on("click keydown", ".reset_variations", function (t) {
                                                        if ("keydown" === t.type) {
                                                            if ("Space" !== t.code && "Enter" !== t.code) return;
                                                            t.preventDefault();
                                                        }
                                                        s.attr("src", l).attr("srcset", ""), d(), h();
                                                    });
                                            }),
                                                i.on("show_variation", function (t, e) {
                                                    jQuery.when(u).done(() => {
                                                        e.image.src
                                                            ? (s.attr("src", e.image.src).attr("srcset", ""),
                                                              c.attr("href", e.image_link),
                                                              d(),
                                                              h())
                                                            : e.image_src &&
                                                              (s.attr("src", e.image_src).attr("srcset", ""),
                                                              c.attr("href", e.image_link),
                                                              d(),
                                                              h());
                                                    });
                ...
                jQuery(function (t) {
                    t(".single_add_to_cart_button").each(function () {
                        const e = t(this);
                        s(function (t) {
                            const o = t.target.classList.contains("disabled");
                            r(e, { ariaDisabled: o });
                        }).observe(e.get(0), { attributes: !0, attributeFilter: ["class"] });
                    });
                }),
                jQuery(function (t) {
                    t(".ux-buy-now-button").each(function () {
                        ...
                        o.length &&
                            s(function (t) {
                                const o = t.target.classList.contains("disabled");
                                e.toggleClass("disabled", o), r(e, { ariaDisabled: o });
                ...
                jQuery(document.body).on("click", ".variations_form .ux-buy-now-button", function (t) {
                    ...
                    "undefined" != typeof wc_add_to_cart_variation_params &&
                        ...
                        e.hasClass("wc-variation-is-unavailable")
                            ...
                            : e.hasClass("wc-variation-selection-needed") &&
                ...
                jQuery(function (t) {
                    ...
                    function o() {
                        !t(".cart-item .nav-dropdown").length ||
                        (window.matchMedia("(max-width: 849px)").matches &&
                            t(".header-main .cart-item .header-cart-link.off-canvas-toggle").length)
                            ? (function () {
                                  let o = 0;
                                  if (t.fn.magnificPopup) {
                                      if (
                                          ((o = t.magnificPopup.instance?.isOpen ? 300 : 0),
                                          o && "#cart-popup" === t.magnificPopup.instance?.currItem?.src)
                                      )
                                          return;
                            ...
                            : (t(".cart-item.has-dropdown").addClass("current-dropdown cart-active"),
                              ...
                              (e.openDropdown = setTimeout(() => {
                                  t(".cart-active").removeClass("current-dropdown cart-active");
                              }, 5e3)));
                    }
                    t("span.added-to-cart").length && o(),
                        ...
                        })(window.flatsomeVars.is_mini_cart_reveal) &&
                                ...
                                o(),
                                    (function () {
                                        ...
                                        o &&
                                            n &&
                                            i &&
                                            (t(".header-wrapper", e).addClass("stuck"),
                                            e.removeClass("sticky-hide-on-scroll--active"));
                                    })();
                            }),
                        t(document).on("flatsome-open-mini-cart", o),
                        t(".shop-container").on("click", () =>
                            t(".cart-item.has-dropdown").removeClass("current-dropdown cart-active")
                        );
                }),
                a(5460),
                a(4696);
            var c = !1;
            const l = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent);
            function u() {
                return window.flatsomeVars.scrollPaddingTop;
            }
            jQuery(document).on("flatsome-product-gallery-tools-init", () => {
                l || (c = jQuery(".has-image-zoom .slide").easyZoom({ loadingNotice: "", preventClicks: !1 })),
                    jQuery(".zoom-button")
                        .off("click.flatsome")
                ...
                jQuery(function (t) {
                    ...
                    const a = t.Deferred(),
                        s = t.Deferred();
                    i.one("flatsome-flickity-ready", () => a.resolve()),
                        n.one("flatsome-flickity-ready", () => s.resolve()),
                        (n.length && !n.is(":hidden")) || s.resolve();
                    const u = function () {
                            c &&
                                c.length &&
                                ((r = c.filter(".has-image-zoom .slide.first").data("easyZoom")),
                                r.swap(
                    ...
                    const f = t.when(a, s).then(() => {
                        l && h(),
                            o.on("hide_variation", function (o, i) {
                                t(".product-thumbnails .first img, .sticky-add-to-cart-img").attr("src", e), h();
                            }),
                            o.on("click keydown", ".reset_variations", function (o) {
                                if ("keydown" === o.type) {
                                    if ("Space" !== o.code && "Enter" !== o.code) return;
                                    o.preventDefault();
                                }
                ...
                jQuery(function (t) {
                    ...
                    function i() {
                        !(function () {
                            ...
                            setTimeout(() => {
                                t.scrollTo("#reviews", { offset: -u() - 15 });
                            }, 500);
                    }
                ...
                jQuery(function (t) {
                    ...
                    const o = (function (t, e = {}) {
                        ...
                        (o) => {
                            ...
                            e.toggleClass("sticky-add-to-cart--active", n),
                                t("body").toggleClass("has-sticky-product-cart", n);
                        },
                        { threshold: 0 }
                    );
                ...
                jQuery(document.body).on("updated_cart_totals", function () {
                    ...
                    ["lazy-load-images", "quick-view", "wishlist", "cart-refresh", "equalize-box", "a11y"].forEach(
                        (e) => Flatsome.attach(e, t)
                    );
                }),
                jQuery(document).ajaxComplete(function () {
                    Flatsome.attach("add-qty", jQuery(".quantity").parent());
                    const t = jQuery(".woocommerce-checkout .woocommerce-terms-and-conditions-wrapper");
                    ["lightboxes-link", "a11y"].forEach((e) => Flatsome.attach(e, t));
                }),
                ...
                jQuery(function (t) {
                    t("#login-form-popup").find(".woocommerce-notices-wrapper > ul").length > 0 &&
