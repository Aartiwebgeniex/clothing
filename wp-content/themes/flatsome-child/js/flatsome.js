!(function () {
                ...
                Flatsome.behavior("commons", {
                    attach(e) {
                        jQuery("select.resizeselect").resizeselect(),
                            ...
                            jQuery.fn.packery &&
                            (jQuery("[data-packery-options], .has-packery", e).each(function () {
                                let e = jQuery(this);
            ...
            4206: function () {
                ...
                Flatsome.behavior("nav-hover", {
                    attach(t) {
                        ...
                        n.length &&
                            (n.removeClass(e), jQuery([".nav-prompts-overlay li.menu-item", ".nav-prompts-overlay .header-vertical-menu__opener"].join(", "), t).on({ mouseenter: () => n.addClass(e), mouseleave: () => n.removeClass(e) }));
                    },
                });
            },
            6241: function () {
                        ...
                        o.length ? (o.children().lazyTooltipster("destroy"), o.empty()) : ((o = jQuery('<div class="scroll-to-bullets hide-for-medium"/>')), jQuery("body").append(o)),
                            ...
                            e.each(function (e, t) {
                                ...
                                if (i.data("bullet")) {
                                    ...
                                    e.lazyTooltipster({ position: "left", delay: 50, contentAsHTML: !0, touchDevices: !1 }), o.append(e);
                                }
                            ...
                            s.removeAttr("style"),
                                r.each(function (t, i) {
                                    ...
                                    u.on("click", function (n) {
                                        ...
                                        (decodeURIComponent(n.substring(1)) !== u.attr("href")?.split("#")[1] && n.substring(1) !== u.attr("href")?.split("#")[1]) ||
                                        (e(t, r, s),
                                            o ||
                                            ((o = !0),
                                                setTimeout(() => {
                            ...
                            ((window.onYouTubePlayerAPIReady = function () {
                                r.each(function () {
                                    ...
                                    new YT.Player(t, {
                                        height: "100%",
                                        width: "100%",
                                        playerVars: { html5: 1, autoplay: 1, controls: 0, rel: 0, modestbranding: 1, playsinline: 1, showinfo: 0, fs: 0, loop: o, el: 0, playlist: o ? n : void 0 },
                                        videoId: n,
                                        events: {
                                            onReady: function (e) {
                                                0 === i && e.target.mute();
                                ...
                                t.getElementById(o) || (((i = t.createElement(n)).id = o), (i.src = "https://www.youtube.com/player_api"), a.parentNode.insertBefore(i, a)));
                    },
                });
            },
            3094: function (e, t, n) {
                        ...
                        t &&
                            setTimeout(() => {
                                ...
                                e.hasClass("menu-item-has-block has-dropdown") &&
                                    ...
                                    (n && jQuery(".header-vertical-menu__fly-out").addClass("header-vertical-menu__fly-out--open"), jQuery(`#menu-item-${t} a:first`).trigger("click"));
                            }, 1e3);
                    }),
            ...
            1711: function (e, t, n) {
                jQuery.fn.lazyTooltipster = function (e) {
                    return this.each((t, o) => {
                        const i = jQuery(o);
                        "string" == typeof e
                            ? jQuery.fn.tooltipster && i.hasClass("tooltipstered") && i.tooltipster(e)
                            : i.one("mouseenter", (t) => {
                                !(function (e, t) {
                                    (jQuery.fn.tooltipster ? Promise.resolve() : n.e(635).then(n.t.bind(n, 2650, 23))).then(() => {
                                        e.hasClass("tooltipstered") || e.tooltipster({ theme: "tooltipster-default", delay: 10, animationDuration: 300, ...t }), e.tooltipster("show");
                                    });
                                })(i, e);
                            });
                    });
                    ...
                    if (void 0 === document.documentElement.style["touch-action"] && !document.documentElement.style["-ms-touch-action"] && t && e) {
                        ...
                        (window.Hammer.time = {
                            ...
                            styleUpdater: function (e) {
                                if (e.target.updateNext) e.target.updateNext = !1;
                                    ...
                                    t
                                        ...
                                        : !t &&
                                        ((e.oldValue && this.checkStyleString(e.oldValue)) || e.target.hadTouchNone) &&
                                        ((e.target.hadTouchNone = !0), (e.target.updateNext = !1), e.target.setAttribute("style", e.target.getAttribute("style") + " touch-action: none;"));
                                }
                            },
                            ...
                            installObserver: function () {
                                this.observer = new e(this.styleWatcher.bind(this)).observe(document, { subtree: !0, attributes: !0, attributeOldValue: !0, attributeFilter: ["style"] });
                            },
                            install: function () {
                            ...
                            return (function (e, t) {
                                ...
                                function r(e, t, s) {
                                    ...
                                    "string" == typeof e && (c = document.querySelectorAll(e)),
                                        c
                                            ? ((this.elements = ((l = c), Array.isArray(l) ? l : "object" == typeof l && "number" == typeof l.length ? a.call(l) : [l])),
                                                        ...
                                                        e.each(s.axis.split(""), function (e, n) {
                                                            ...
                                                            if (c)
                                                                (p[a] = c[i] + (u ? 0 : r - h.offset()[i])),
                                                                    s.margin && ((p[a] -= parseInt(f.css("margin" + o), 10) || 0), (p[a] -= parseInt(f.css("border" + o + "Width"), 10) || 0)),
                                                                    (p[a] += y[i] || 0),
                                                                    s.over[i] && (p[a] += f["x" === n ? "width" : "height"]() * s.over[i]);
                                                            else {
                                                                var v = f[i];
    ...
    (r.m = i),
        ...
        (r.u = function (e) {
            return "js/chunk." + { 230: "popups", 436: "slider", 635: "tooltips", 970: "lottie", 987: "countup" }[e] + ".js";
        }),
        ...
        (function () {
            ...
            function v(e, t = "down", n = !1) {
                void 0 === u &&
                    ...
                    (h.hasClass("sticky-shrink")
                        ? ((u = p.hasClass("hide-for-sticky") ? p.height() : 0), (u += y.hasClass("hide-for-sticky") ? y.height() : 0), (d = 1 + u))
                        : ((u = f.height() + 100), (d = p.hasClass("hide-for-sticky") ? p.height() + 1 : 1))),
                    g
                        ? "down" === t || e < d
                            ? e < d
                                ? j()
                                : ((c = setTimeout(j, 100)), h.addClass("sticky-hide-on-scroll--active"))
                            : e > u && ((c = setTimeout(() => b(n), 100)), h.removeClass("sticky-hide-on-scroll--active"))
                        : e > u
                            ? b(n)
                            : e < d && j();
            }
                            ...
                            this.each((t, n) =>
                                (function (t) {
                                    t.classList.add("parallax-active"),
                                        (!document.querySelector("body").classList.contains("parallax-mobile") && e()) || (t.classList && t.dataset && (x.push({ element: t, type: L(t) }), T(x[x.length - 1])));
                                })(n)
                            ));
                }),
                r(9207),
                ...
                if (e.intersectionRatio > 0) {
                    ...
                    r.e(987)
                        ...
                        .then(({ CountUp: e }) => {
                            ...
                            new e(t.get(0), n, { decimalPlaces: 0, duration: 4 }).start(), t.addClass("active");
                        });
                }
            });
            function S(e) {
                e.addClass("current-dropdown"),
                    ...
                    (function (e) {
                        ...
                        if (a) {
                            ...
                            t.css({ width: s ? n - o.width() : n, ...(!c && { left: e.left - i.left + 15 }), ...(c && { right: 15 - (e.right - i.right) }) });
                        }
                        if (i) {
                            t.css({ inset: "0" });
                            const e = document.body,
                                ...
                                a = e.clientWidth;
                            t.css({
                                ...(!c && { width: s ? a - o.get(0).getBoundingClientRect().right : a }),
                                ...(c && { width: s ? o.get(0).getBoundingClientRect().left : a }),
                        ...
                        if ((a || i) && !s) {
                            let e = null;
                            if (
                                (o.closest("#top-bar").length && (e = document.querySelector("#top-bar")),
                                    o.closest("#masthead").length && (e = document.querySelector("#masthead")),
                                    o.closest("#wide-nav").length && (e = document.querySelector("#wide-nav")),
                                    null !== e)
                            ) {
                        ...
                        s && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && t.css({ minHeight: t.closest(".header-vertical-menu__fly-out").outerHeight() });
                    })(e.find(".nav-dropdown"));
            }
            function $(e) {
            ...
            Flatsome.behavior("count-up", {
                                        ...
                                        t && jQuery.magnificPopup.close(),
                                            setTimeout(function () {
                                                jQuery.magnificPopup.open({
                                                    ...
                                                    closeBtnInside: flatsomeVars.lightbox.close_btn_inside,
                                                    closeMarkup: flatsomeVars.lightbox.close_markup,
                                                    items: { src: e, type: "inline", tLoading: '<div class="loading-spin dark"></div>' },
                                                    callbacks: {
                                                        beforeOpen: function () {
                                                            a();
                                                        },
                                                        open: function () {
                                                            if (
                                                                (Flatsome.attach(this.content),
                                                                    jQuery.fn.flickity &&
                                                                    jQuery("[data-flickity-options].flickity-enabled", this.content).each((e, t) => {
                ...
                Flatsome.behavior("slider", {
                    attach(e) {
                        var t;
                        (t = jQuery(e).data("flickityOptions") ? jQuery(e) : jQuery("[data-flickity-options]", e)).length &&
                            t.each((e, t) => {
                                var n = jQuery(t),
                    ...
                    attach(t) {
                        ...
                        jQuery(".accordion-title", t).each(function () {
                            jQuery(this)
                                ...
                                !n.substring(1).length ||
                                (decodeURIComponent(n.substring(1)) !== jQuery(this).attr("href")?.split("#")[1] && n.substring(1) !== jQuery(this).attr("href")?.split("#")[1]) ||
                                (jQuery(this).hasClass("active") || jQuery(this).trigger("click"),
                                    o ||
                                    ((o = !0),
                                        setTimeout(() => {
                ...
                Flatsome.behavior("tooltips", {
                    attach(t) {
                        jQuery(".tooltip:not(.hotspot), .has-tooltip, .tip-top, li.chosen a", t).lazyTooltipster(),
                            jQuery(".tooltip-as-html", t).lazyTooltipster({ interactive: !0, contentAsHTML: !0 }),
                            e() ? jQuery(".hotspot.tooltip:not(.quick-view)", t).lazyTooltipster({ trigger: "click" }) : jQuery(".hotspot.tooltip", t).lazyTooltipster();
                    },
                });
            ...
            Flatsome.behavior("sticky-sidebar", {
                attach(e) {
                    jQuery('.is-sticky-column[data-sticky-mode="javascript"]', e).each((e, t) => {
                        "ResizeObserver" in window && t.offsetParent && t.offsetParent !== document.body
                            ? jQuery(t).data(
                                q,
                                (function (e) {
                                    ...
                                    const d = (t = "down") => {
                                        ...
                                        !a || r?.height < i - n
                                            ...
                                            : "down" === t
                                                ? o <= s
                                                    ? (h = d)
                                                    : r?.height - o <= i && ((f = i - Math.round(r?.height)), (s = o))
                                                : "up" === t && (o <= l ? ((f = n), (s = o + Math.round(r?.height) - i + n)) : (h = d)),
                            ...
                            e.isIntersecting &&
                                (n.unobserve(e.target),
                                    (function (e) {
                                        ...
                                        Promise.all([r.e(970).then(r.bind(r, 9371)), r.e(970).then(r.bind(r, 1204))]).then(([, { create: e }]) => {
                                            t.load(n.src),
                                                t.addEventListener("ready", () => {
                                                    (o = t.getLottie()), (i = o.animationData);
                                                    const { autoplay: r, controls: l, direction: c, end: u, id: d, loop: h, mouseout: f, speed: p, start: y, trigger: m, scrollActionType: g, visibilityEnd: v, visibilityStart: b } = n;
                                                    (t.__controls = l),
                                                        t.setLooping(h),
                                                        ...
                                                        r ||
                                                        (t.pause(),
                                                            "scroll" === m && e({ player: `#${d} .ux-lottie__player`, mode: "scroll", actions: [{ visibility: [b / 100, v / 100], type: g, frames: [s(y), s(u)] }] }),
                                                            "hover" === m &&
                ...
                ("Prefer reduced motion is active on your OS",
                    ...
                    console.groupCollapsed("%cFlatsome%c: Prefer reduced motion is active on your OS", "color: #0693e3; font-weight: bold;", "color: inherit;"),
                    console.log(
                        "The prefers-reduced-motion media feature is used to detect if the user has requested the system minimize the amount of non-essential motion it uses. With this option enabled, slides & animations are reduced on the frontend.\nCheck your OS documentation on how to disable reduced motion."
                    ),
                    console.groupEnd());
                ...
                window.removeEventListener("keydown", X),
                    ...
                    (function () {
                        ...
                        (W = Math.round(window.flatsomeVars.stickyHeaderHeight + t)),
                            ...
                            jQuery.extend(jQuery.scrollTo.defaults, { axis: "y", duration: k || (U && "smooth" === Y) ? 0 : 1e3, offset: -W, easing: "fsEaseInOutExpo" });
                    })();
            }
            document.addEventListener("DOMContentLoaded", () => {
                window.location.hash || window.scrollY > 200 ? X() : (window.addEventListener("keydown", X, { once: !0 }), window.addEventListener("pointermove", X, { once: !0 }), window.addEventListener("touchstart", X, { once: !0 }));
            });
