...
if (is_woocommerce_activated() && flatsome_is_wc_cart_available()) {
  ...
  $link_atts = array(
    'href'  => is_customize_preview() ? '#' : 'javascript:void(0);', // Prevent none link mode to navigate in customizer.
  ...
  ?>
  <li class="cart-item xoo-wsc-cart-trigger has-icon<?php if ($cart_style == 'dropdown') { ?> has-dropdown<?php } ?>">
