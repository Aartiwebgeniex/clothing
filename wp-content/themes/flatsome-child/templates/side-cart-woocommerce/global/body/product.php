...
<div data-key="<?php echo $cart_item_key ?>" class="<?php echo implode(' ', $productClasses) ?>">
	...
	<div class="xoo-wsc-sum-col">
		...
		<div class="xoo-wsc-sm-info">
			...
			<div class="xoo-wsc-sm-left pc-<?php echo $customPtype; ?>">
	   ...
	   if (isset($cart_item['stamp'])):
		   foreach ($cart_item['stamp'] as $data):
			   if (isset($data['key'])):
				   ?>
	...
	<?php
	   ...
	   ?>
				...
				$attributes = $_product->is_type('variation') ? wc_get_formatted_variation($_product) : '';
