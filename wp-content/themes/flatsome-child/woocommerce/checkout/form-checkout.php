	...
	<div class="row pt-0 <?php echo esc_attr( $row_classes ); ?>">
		...
		<div class="large-5 col">
			<?php flatsome_sticky_column_open( 'checkout_sticky_sidebar' ); ?>
					...
					<h2 id="cursyd" style="color:red;font-weight:bold; font-size:18px;"> Prices shown are AUD (Australian dollars)</h2>
					<img src="<?php echo esc_url(get_site_url() . '/wp-content/uploads/2022/11/Down-Arrow.gif'); ?>" alt="" style="width:35px;float:right;">
...
<script>
	jQuery(document).ready(function ($) {
		//console.log($('.wmc-currency.wmc-active').data('currency'));
		if ($('.wmc-currency.wmc-active').data('currency') === 'AUD') {
			$('#cursyd').hide()
		}
	})
</script>
