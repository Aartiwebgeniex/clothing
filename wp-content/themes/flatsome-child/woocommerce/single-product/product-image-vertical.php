...
if(get_post_meta($product->get_id(), '_custom_product_video', true) != ''){
	$video_id = get_post_meta($product->get_id(), '_custom_product_video', true);
	$youtubeurl="https://www.youtube.com/embed/".get_post_meta($product->get_id(), '_custom_product_video', true);
	?>
<div class="cvideo">
	  <a href="#" class="js-video-button" data-video-id="<?php echo $video_id;?>">
...
right: auto;
    ...
    text-align: center;
    padding: 8px 0 0;
    box-shadow: 1px 0px 4px 1px #f5eaea;
    color: #fff;
...
@media screen and ( max-width: 782px ) {
	...
	<script src="<?php echo get_stylesheet_directory_uri();?>/js/modal-video.min.js"></script>
	<script>
