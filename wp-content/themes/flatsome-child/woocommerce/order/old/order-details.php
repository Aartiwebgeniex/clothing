...
<div class="row order-via">
    ...
    ?> 
					...
					<span><?php $shipping_address_1 = $order->get_shipping_address_1();
...
<span>Need Help? <a href="<?php echo get_site_url();?>/contact/">Drop us a line.</a></span>
<a href="<?php echo get_site_url();?>"><span>Plus2clothing.com</span></a> 
