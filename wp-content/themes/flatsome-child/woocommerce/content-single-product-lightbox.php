...
<div class="product-quick-view-container">
	<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'row row-collapse mb-0', $product ); ?>>
		...
		<div class="product-info summary large-6 col entry-summary" style="font-size:90%;">
			<div class="product-lightbox-inner" style="padding: 30px;" data-quantity="<?php echo $maxQ; ?>" total-cart-quantity="<?php echo $total_quantity; ?>">
				...
				$maxQ = get_post_meta($post->ID, 'maximum_allowed_quantity', true);
				if ($maxQ == 1) {
					echo '<input type="hidden" value="' . $maxQ . '" class="clightbox mxq">';
				...
				<?php // CUSTOM START  ?>
				<span class="perror" style="display:block !important;color:red;margin-top:50px"></span>
				<?php // CUSTOM END  ?>
			</div>
		</div>
	</div>
